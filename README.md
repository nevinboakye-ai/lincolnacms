...
- No-code-ish: use Formspree — just change the `<form>` tag’s `action` to your Formspree endpoint
- If you end up hosting on Netlify: add `netlify` and `name="join"` attributes to the `<form>` tag (Netlify Forms docs)
